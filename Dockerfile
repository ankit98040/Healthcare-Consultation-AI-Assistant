...
# Build argument for Clerk public key with default fallback to real key
ARG NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_YWRqdXN0ZWQtYm9hLTk2LmNsZXJrLmFjY291bnRzLmRldiQ
